    ...
    <h4 class="my-4 text-center">saving to your updates click  the change button</h4>
        <table class="table table-bordered">
            ...
            <tr>
                    ...
                    <td><input id="${table.id}" type="text" value="${table.special_price}" name="special_price"/></td>
                    <td><input id="${table.id}" type="text" value="${table.available}" name="available"/></td>
                    <td><button class="btn btn-success" name="action" value="${table.id}" >Change</button></td>
                </tr>
            </form >
            </c:forEach>
